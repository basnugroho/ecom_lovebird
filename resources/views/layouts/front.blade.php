...
<head>
    ...
    <title>B.M.W Master - Solusi Burung Anda</title>
    ...
    <!-- Css animations  -->
    <link href="{{ asset('universal/css/animate.css') }}" rel="stylesheet">

    <!-- Theme stylesheet, if possible do not edit this stylesheet -->
    <link href="{{ asset('universal/css/style.default.css') }}" rel="stylesheet" id="theme-stylesheet">

    <!-- Custom stylesheet - for your changes -->
    <link href="{{ asset('universal/css/custom.css') }}" rel="stylesheet">
...
<![endif]-->
    ...
    <link rel="shortcut icon" href="{{ asset('universal/img/favicon.ico') }}" type="image/x-icon')" />
    <link rel="apple-touch-icon" href="{{ asset('universal/img/apple-touch-icon.png') }}" />
            ...
            <div class="container">
                ...
                <!-- <div class="col-md-3 col-sm-6">
                    ...
                    <div class="photostream">
                        <div>
                            <a href="#">
                                <img src="{{ asset('universal/img/detailsquare.jpg') }}" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="{{ asset('universal/img/detailsquare2.jpg') }}" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="{{ asset('universal/img/detailsquare3.jpg') }}" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
...
_________________________________________________________ -->
        ...
        <div id="copyright">
            <div class="container">
                <div class="col-md-12">
                    <p class="pull-left">&copy; 2017 CV. RAJAWALI NUANSA INDAH</p>
